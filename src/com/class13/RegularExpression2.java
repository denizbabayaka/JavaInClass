...
public class RegularExpression2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(str.replaceAll("\\s", "")); // custom expression for removing spaces 
...
String str1="Today is our java class";
		...
		System.out.println(doc.replaceAll("powerful(.*)", ""));  // custom expression removes including powerful
        System.out.println(doc.replaceFirst(" ", " Deniz ")); // replace the first space 
	}
