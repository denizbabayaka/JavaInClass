...
public class CardTest {
	public static void main(String[] args) {
	  ...
	  //type reference variable= object is created
		Card card=new AX();
		card.chargeInterest();// 
		card.creditLimit();// during the runtime this method which overridden in child class executed
		 ...
		 // we created the object and assigned to the variables and then 
		 // stored those variables inside  to the array 
		 ...
		 System.out.println("creating an array that will hold only MC type");
